// Phase D / PD-3 input for the sturm-transpile snapshot test.
//
// Exercises the qint-qint form of LT on a qint_t: `qbool c = a < b;` must
// be paired with `uncompute_lt_qint(c, a, b);` injected before the scope's
