// Phase D / PD-5 input for the sturm-transpile snapshot test.
//
// Exercises the qint-qint form of GT on a qint_t: `qbool c = a > b;` must
// be paired with `uncompute_gt_qint(c, a, b);` injected before the scope's
