// Phase D / PD-2 input for the sturm-transpile snapshot test.
//
// Exercises the qint-qint form of NE on a qint_t: `qbool c = a != b;` must
// be paired with `uncompute_ne_qint(c, a, b);` injected before the scope's
