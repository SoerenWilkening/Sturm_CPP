// Phase C / PC-2 input for the sturm-transpile snapshot test.
//
// Exercises the qint RHS form of SUB_ASSIGN on a qint_t: `a -= b;` must
// be paired with `uncompute_sub_qint(a, b);` injected before the scope's
