// Phase D / PD-6 input for the sturm-transpile snapshot test.
//
// Exercises the qint-qint form of GE on a qint_t: `qbool c = a >= b;` must
// be paired with `uncompute_ge_qint(c, a, b);` injected before the scope's
