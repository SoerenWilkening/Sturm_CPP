// qint_alias_subst_field.cpp -- sturm-65rs.9 (Beat C2) input fixture.
//
// PRD §4.3 / Plan §10. FieldDecl anchor. Per PRD §3 non-goal:
...
// emitter falls through to `kDefaultWidth = 32` for record fields.
