// primitives.hpp — M11/M20 (PRD v3): frozen backend primitive surface via execute_gate.
//
// Declares exactly five primitives in the sturm:: namespace.
...
//
// Renamed from primitives_v3.hpp as part of M20 cleanup (v2 state code removed).
//
