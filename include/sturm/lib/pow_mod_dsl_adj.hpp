// pow_mod_dsl_adj.hpp -- P0 scaffold (sturm-r5pn.1) for __lib_pow_mod_dsl_adj.
//
// Stub adjoint sibling. Full implementation arrives in Phase 3 once the
...
inline void __lib_pow_mod_dsl_adj(Bit* /*base_bits*/, Bit* /*exp_bits*/,
                                  ...
                                  Bit* /*r_bits*/) {
    if (n == 0u) return;
    assert(false && "__lib_pow_mod_dsl_adj: not implemented (Phase 3)");
}
