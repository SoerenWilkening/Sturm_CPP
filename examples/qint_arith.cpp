...
//
// NOTE on STURM_AUTO_UNCOMPUTE: same caveat as example_constant_arith —
// the build defaults to ON, which layers the destructor's auto-uncompute
// on top of the transpiler's injection. To see ONLY the transpiler's
